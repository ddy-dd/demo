...
//                .build();
        ...
        this.chatClient = chatClientBuilder.defaultSystem("你是一个对话智能体，你必须用中文回答，除非用户强制你用英文").defaultAdvisors(retrievalAugmentationAdvisor, memoryAdvisor, customLogger).build();
